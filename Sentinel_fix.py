...
#
#
# Minor bug fixes during Linux Kernel detachment and timing tweaks
# for Dream Cheeky Thunder (0x2123) done by G Radons June 2014
...
class Launcher1130():
	...
	# HID detatch for Linux systems...not tested with 0x1130 product
    ...
    def turretMove(self, cmd):
        ...
        # roughly centers the turret  (full rotation is 7-8 sec)
    def center(self):
...
class Launcher2123():
	...
	# HID detatch for Linux systems...tested with 0x2123 product
